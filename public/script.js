...
var confirmedColor;
var games = [];
var instructionUrls = ["./instructions0.jpg", "./instructions1.jpg", "./instructions2.jpg", "./instructions3.jpg", "./instructions4.jpg", "./instructions5.jpg", "./instructions6.jpg", "./instructions7.jpg", "./instructions8.jpg", "./instructions9.jpg", "./instructions10.jpg"];
var currentInstruction = 0;
fireworkCanvas.style.display = "none";
var buttonSound = new Audio("https://raw.githubusercontent.com/Beasleydog/seekingorder/main/buttonPress.mp3");
var clickSound = new Audio("https://raw.githubusercontent.com/Beasleydog/seekingorder/main/click.mp3");
...
document.onkeydown = function (e) {
  if (e.key == "Escape") {
    if (creditPopup.style.opacity == "1" || instructions.style.opacity == "1") {
      creditPopup.style.opacity = "0";
      creditPopup.style.pointerEvents = "none";
...
credits.onclick = function () {
  creditPopup.style.opacity = "1";
  creditPopup.style.pointerEvents = "unset";
  buttonSound.play();
}
...
function updateWord() {
  wordDisplay.innerText = wordList[Math.floor(Math.random() * wordList.length)];
}
updateWord();
var indentAmount = 10;
